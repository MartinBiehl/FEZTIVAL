...
export const landingContent = {
  ...
  catalog: {
    ...
    description: 'Os mais bem avaliados de Ivoti e região',
  ...
  about: {
    ...
    description:
      'Nascemos em Ivoti com uma missão simples: todo evento merece o artista certo — e todo artista merece ser encontrado.',
  },
  cta: {
  ...
  footer: {
    ...
    copyright: '© 2026 Feztival. Ivoti, RS.',
  },
};
...
export const artists = [
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 71,
    location: 'Jardim Panorâmico, Ivoti',
    distanceKm: 5,
    setMinutes: [120, 180, 240],
    color: '#FFD600',
    image: null,
    imageAlt: 'Grupo Samba Ivoti se apresentando',
  },
  {
    id: 7,
    slug: 'leticia-black',
...
export const values = [
  ...
  { title: 'Ivoti', description: 'Feitos aqui, para cá. Apostamos no talento gaúcho.', color: '#00D4FF' },
];
